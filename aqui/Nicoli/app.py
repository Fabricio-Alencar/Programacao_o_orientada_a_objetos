...
@app.route('/cadastrar_profissional', methods=['GET'])
def cadastrar_profissional():
    return render_template('cadastrar_profissional.html')  # Renderiza a página de cadastro de profissional
...
def cadastrar_paciente():
    if request.method == 'POST':
        ...
        if verificar_email_existente(email):
            return render_template('cadastrar_paciente.html', mensagem='Email já está cadastrado.')
        ...
        return render_template('cadastrar_paciente.html')  # Renderiza a página de cadastro de paciente para GET
...
def verificar_email_existente(email):
    ...
    return usuario is not None  # Retorna True se o email existir
